...
describe('PrologPackageManager', () => {
  ...
  beforeEach(() => {
    ...
    packageManager = new PrologPackageManager(mockBackend);
  ...
  describe('installPack', () => {
    beforeEach(() => {
      ...
      windowStub.withProgress.callsFake(
        (
          options: unknown,
          callback: (
            progress: { report: sinon.SinonStub },
  ...
  describe('uninstallPack', () => {
    beforeEach(() => {
      windowStub.withProgress.callsFake(
        (options: unknown, callback: (progress: { report: sinon.SinonStub }) => unknown) => {
          const mockProgress = { report: sinon.stub() };
  ...
  describe('validatePackSecurity', () => {
    it('should validate pack security and return warnings', async () => {
      ...
      expect(result.warnings.some(w => w.includes('not from the official SWI-Prolog repository')))
        .to.be.true;
  ...
  describe('pack name validation', () => {
    it('should accept valid pack names', () => {
      ...
      for (const name of validNames) {
        const result = (
          packageManager as unknown as { validatePackName: (name: string) => boolean }
